...
var design = prompt("Let's see how many silkscreens Desi needs to print this week! \nDoes the design require printing on 1 side or 2 sides?");
//Console.log out the response
console.log(design);

//Ask the user how many colors are in the design.
var color = prompt("How many colors are in the design?")
//Console.log out the response
console.log(color);
...
var totalScreens = (design + color) * designNo;
